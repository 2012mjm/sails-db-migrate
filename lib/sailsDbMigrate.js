...
function parseSailsConfig(sailsConfig) {
  ...
  connection = sailsConfig.connections ? sailsConfig.connections[connectionName] : sailsConfig.datastores ? sailsConfig.datastores[connectionName] : null;

  if (!connection) {
    throw new Error('could not find connection ' + connectionName + ' in ./config/datastores.js');
  }
